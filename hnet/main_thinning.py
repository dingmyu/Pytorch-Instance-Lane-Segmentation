...
def main():
    ...
    train_data = MyDataset('new_list_lane.txt', args.dir_path, args.new_width, args.new_length,args.label_width,args.label_length)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target_ins, n_objects, thining_gt) in enumerate(train_loader):
        ...
        loss = loss_seg + loss_ins + loss_cls + loss_hnet
        ...
        if i % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'Lr {lr.val:.5f} ({lr.avg:.5f})\t'.format(
                   ...
                   data_time=data_time, loss_seg=losses_seg, loss_ins=losses_ins, loss_cls=losses_cls, loss_hnet=losses_hnet, lr=lrs))
